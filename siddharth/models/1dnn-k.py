...
np.random.seed(1337)
trainfile="/home/smittal/Desktop/coding/leap/siddharth/combhtk/mfcc-d-a-kurtosis/alltrain.htk"
testfile="/home/smittal/Desktop/coding/leap/siddharth/combhtk/mfcc-d-a-kurtosis/alltest.htk"
...
def load_data_train(trainfile):
    ...
    data=a.getall()
    x_train=data[:,data.shape[1]-2] #Just taking the Kurtosis values
    # x_train=data[:,0:13] #Taking just the MFCC's
    y_train=data[:,-1]
    return x_train,y_train
def load_data_test(testfile):
    a=htk.open(testfile)
    data=a.getall()
    x_test=data[:,data.shape[1]-2] #Just taking the Kurtosis Values
    # x_test=data[:,0:13]
    y_test=data[:,-1]
...
direc="/home/smittal/Desktop/coding/leap/siddharth/matrices/kurt/"
name="1dnn-kurt"
