    ...
    # for i in range(100):
        ...
        try:
            ...
            if read_data.shape[0] == kurt_read.shape[1]:
                fwritedata=np.hstack((read_data,np.transpose(kurt_read)))
            else:
                corrupt_files+=1
...
addr='/home/smittal/Desktop/coding/leap/siddharth/feats/test/aftervads/'
kurt_addr='/home/smittal/Desktop/coding/leap/siddharth/kurtosis/test/aftervads/'
save_addr='/home/smittal/Desktop/coding/leap/siddharth/combhtk/mfcc-d-a-kurtosis/'
num=39+1 #39 for mfcc,d,a and 1 for kurtosis of each frame
file_read='/home/smittal/Desktop/coding/leap/siddharth/lists/singletest/singletestraw.list'
index=0 #For single speaker data, index is 0
filename='test_mfcc_kurt_s'
